...
from utils.Condition_dataloader import split_dataloader
import argparse
from diffusers import (DDPMScheduler, UNet2DConditionModel, 
                       AutoencoderKL, ControlNetModel, 
                       StableDiffusionControlNetPipeline)
import torch
from utils.common import load_config, get_parameters, copy_yaml_to_folder, clip_encode_images
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_path', type=str, default='config/control_net_config.yaml')
