...
def get_args_parser():
    ...
    parser.add_argument('--use_nature_img_loss', type=bool, default=False)
    ...
    parser.add_argument('--do_cross_contrast', type=bool, default=False)
    parser.add_argument('--cross_contrast_loss_weight', type=float)
    parser.add_argument('--do_self_contrast', type=bool, default=False)
    parser.add_argument('--self_contrast_loss_weight ', type=float)
...
def main(config):
    ...
    model = MAEforEEGContrast(time_len=dataset_pretrain.data_len, patch_size=config.patch_size, embed_dim=config.embed_dim,
                      ...
                      do_self_contrast=config.do_self_contrast, self_contrast_loss_weight=config.self_contrast_loss_weight,
                      contrast_loss_weight=config.contrast_loss_weight,
                      do_cross_contrast=config.do_cross_contrast, cross_contrast_loss_weight=config.cross_contrast_loss_weight,
